...
:---: | :--------: | :------: | :------: | :-------------:
16 | 2023-03-09 | **[Slides (15 and) 16](https://github.com/THOMASELOVE/432-slides-2023/blob/main/slides15_16.pdf)** | **[Code (15 and) 16](https://github.com/THOMASELOVE/432-slides-2023/blob/main/slides15_16.qmd)** | Visit [Canvas](https://canvas.case.edu/), select **Zoom** and **Cloud Recordings**
...
1. [Project A Portfolio](https://thomaselove.github.io/432-2023/projA.html) - be sure to complete all of the necessary tasks and submit everything by Monday 2023-03-20 at 9 PM.
    - If you're worried that you're not doing something you should be doing in your Quarto and HTML, [this template](https://github.com/THOMASELOVE/432-data/blob/master/templates/projectAportfolio_template.qmd) and this set of instructions for [Section 8](https://thomaselove.github.io/432-2023/projA.html#new-section-8.-linear-regression-analyses), [Section 9](https://thomaselove.github.io/432-2023/projA.html#new-section-9.-logistic-regression-analyses) and [Section 10](https://thomaselove.github.io/432-2023/projA.html#new-section-10.-discussion) are meant to take that worry away.
