...
2. I have added several new Chapters to [the Course Notes](https://thomaselove.github.io/432-notes/).
    - I have added the `prost` and `resect` data (used in these new chapters) to [our 432-data page](https://github.com/THOMASELOVE/432-data).
